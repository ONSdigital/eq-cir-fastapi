...
1. Start your Docker container manager
2. Open a terminal at the project root
...
To run CIR locally, run the following command (Please ensure your GCloud project is set to the desired project). You will need to log in to GCP after running the command:
...
Please ensure your user account has been granted with the role "Service Account Token Creator" in the project to be able to generate auth tokens for testing. If you are using the sandbox project, this role should already be granted to your user account.
...
This will need the app to be running on docker before running the command.
