...
async def patch_collection_instrument_validator_version(
    ...
    # Use guid from path, but allow fallback to query param for compatibility
    ...
    if not ci_metadata:
        error_message = "patch_collection_instrument_validator_version: exception raised - No collection instrument metadata found"
