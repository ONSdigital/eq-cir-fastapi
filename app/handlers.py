...
from app.models.requests import GetCiMetadataV1Params, PostCiMetadataV1Params
...
def delete_ci_v1(request):
    ...
    if survey_id.isnumeric():
        ci_schemas = query_ci_by_survey_id(survey_id)
        with db.transaction() as transaction:
            # Deleting the metadata from firestore
            delete_ci_metadata(survey_id)
