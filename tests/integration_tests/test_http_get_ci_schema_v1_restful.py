...
class TestHttpGetCiSchemaV1Restful:
    ...
    def test_endpoint_returns_400_bad_request_if_bad_query(self):
        """
        What am I testing:
        `get_collection_instrument_schema_v1` should return `HTTP_400_BAD_REQUEST` status if a bad query is made
        via a GET request
        """
    ...
    def test_endpoint_returns_404_not_found_if_ci_not_found(self, setup_payload):
        """
        What am I testing:
        `get_collection_instrument_schema_v1` should return `HTTP_404_NOT_FOUND` status if a valid query is
    ...
    def test_endpoint_returns_200_success_if_ci_schema_found(self, setup_payload):
        """
        What am I testing:
        `get_collection_instrument_schema_v1` should return `HTTP_200_OK` status if valid ci metadata and schema
    ...
    def test_endpoint_returns_unauthorized_request(self, setup_payload):
        """
        What am I testing:
        get_collection_instrument_schema_v1 should return a 401 unauthorized error if the endpoint is requested with an unauthorized token.
        """
