...
class TestCiFirebaseRepository:
    ...
    def test_query_ci_by_survey_id_returns_single_ci_if_found(
        ...
        found_ci = firestore_client.get_ci_metadata_collection_with_survey_id(
            mock_survey_id
        )

        assert found_ci == [mock_ci_metadata]

    def test_query_ci_by_survey_id_returns_multiple_ci_if_found(
        self, mock_firestore_collection
    ):
        """
    ...
    def test_query_ci_by_survey_id_returns_empty_list_if_ci_not_found(
        self, mock_firestore_collection
    ):
        """
    ...
    def test_query_latest_ci_version_returns_latest_ci_version(
        self, mock_firestore_collection
    ):
        """
    ...
    def test_query_latest_ci_version_id_returns_latest_id(
        ...
        mock_firestore_collection.document(mock_next_version_id).set(
            mock_next_version_ci_metadata.__dict__
        )
    ...
    def test_get_query_ci_metadata_with_guid_returns_none(
        self, mock_firestore_collection
    ):
        """
