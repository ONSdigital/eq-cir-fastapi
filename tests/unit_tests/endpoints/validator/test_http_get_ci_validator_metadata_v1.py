...
from tests.test_data.ci_test_data import mock_ci_validator_metadata_list, mock_ci_metadata_list
...
class TestHttpGetCiValidatorMetadataV1:
    ...
    def test_endpoint_returns_200(self, mock_get_ci_metadata_collection):
        """
        Tests the `http_get_ci_validator_metadata` endpoint returns 200 with expected data.
        """
        mock_get_ci_metadata_collection.return_value = mock_ci_metadata_list
